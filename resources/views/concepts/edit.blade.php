<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Edit Concept in {{ $concept->domain->name }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('domains.concepts.update', [$concept->domain, $concept]) }}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="flex items-center justify-end gap-4">
                            ...
                            <x-primary-button>Update Concept</x-primary-button>
                        </div>
                    </form>
                </div>
            </div>
